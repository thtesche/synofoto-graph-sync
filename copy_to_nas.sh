...
ssh ${NAS_USER}@${NAS_IP} "find ${NAS_DEST_PATH} -name '._*' -delete; rm -f ${NAS_DEST_PATH}/setup_*.sh ${NAS_DEST_PATH}/copy_to_nas.sh ${NAS_DEST_PATH}/README.md ${NAS_DEST_PATH}/.env.example ${NAS_DEST_PATH}/.gitignore; rm -rf ${NAS_DEST_PATH}/scripts"
